...
hero:
  name: "IssueFlow 学习站"
  text: "从零建立现代前端工程能力"
  tagline: "沿着一个真实 Issue Tracker，依次学习浏览器、TypeScript、React、数据请求、双后端与测试。"
  actions:
    - theme: brand
      text: 从第 00 章开始
      link: /learning/00-getting-started
    - theme: alt
      text: TypeScript 专题
      link: /typescript/
    - theme: alt
...
features:
  ...
  - icon: "TS"
    ...
    details: 六个专题、十二个可运行实验，覆盖编译期建模与运行时边界。
  - icon: "→"
    title: 源码驱动
...
1. 先运行项目，完成一次 Issue 生命周期。
2. 学习浏览器、HTML、CSS、JavaScript 与 HTTP。
3. 进入 TypeScript Lab，再学习 React、Router 和 TanStack Query。
4. 最后连接 D1/R2 与 .NET 后端，完成综合练习。
...
| 你的情况        | 建议入口                                                          | 第一阶段成果                               |
| --------------- | ----------------------------------------------------------------- | ------------------------------------------ |
| 没有前端经验    | [从第 00 章开始](learning/00-getting-started.md)                  | 能运行项目，并用 DevTools 解释一次页面请求 |
