        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedTitle = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Issues_Members_AssigneeId",
                        column: x => x.AssigneeId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Issues_Members_ReporterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachments_IssueId_CreatedAt",
                table: "Attachments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Issues_NormalizedTitle",
                table: "Issues",
